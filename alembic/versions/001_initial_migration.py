...
def upgrade() -> None:
    ...
    op.create_table('projects',
        ...
        sa.Column('status', postgresql.ENUM('active', 'inactive', 'error', name='projectstatus'), nullable=True),
    ...
    op.create_table('deployments',
        ...
        sa.Column('status', postgresql.ENUM('pending', 'building', 'deploying', 'success', 'failed', 'cancelled', name='deploymentstatus'), nullable=True),
